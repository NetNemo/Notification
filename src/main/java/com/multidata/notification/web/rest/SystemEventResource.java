...
public class SystemEventResource {
    ...
    private static final String ENTITY_NAME = "notificationSystemEvent";
    ...
    @Timed
    public ResponseEntity<SystemEventDTO> getSystemEvent(@PathVariable Long id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteSystemEvent(@PathVariable Long id) {
