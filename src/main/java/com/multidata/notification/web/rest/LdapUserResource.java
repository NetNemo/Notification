...
public class LdapUserResource {
    ...
    private static final String ENTITY_NAME = "notificationLdapUser";
    ...
    @Timed
    public ResponseEntity<LdapUserDTO> getLdapUser(@PathVariable Long id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteLdapUser(@PathVariable Long id) {
