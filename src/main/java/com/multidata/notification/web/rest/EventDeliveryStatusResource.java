...
public class EventDeliveryStatusResource {
    ...
    private static final String ENTITY_NAME = "notificationEventDeliveryStatus";
    ...
    @Timed
    public ResponseEntity<EventDeliveryStatusDTO> getEventDeliveryStatus(@PathVariable Long id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteEventDeliveryStatus(@PathVariable Long id) {
