...
import com.multidata.notification.web.rest.errors.BadRequestAlertException;
import com.multidata.notification.web.rest.util.HeaderUtil;
import com.multidata.notification.web.rest.util.PaginationUtil;
...
public class UserChannelConfigurationResource {
    ...
    private static final String ENTITY_NAME = "notificationUserChannelConfiguration";
    ...
    @Timed
    public ResponseEntity<UserChannelConfigurationDTO> getUserChannelConfiguration(@PathVariable Long id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteUserChannelConfiguration(@PathVariable Long id) {
