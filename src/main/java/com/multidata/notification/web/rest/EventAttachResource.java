...
public class EventAttachResource {
    ...
    private static final String ENTITY_NAME = "notificationEventAttach";
    ...
    @Timed
    public ResponseEntity<EventAttachDTO> getEventAttach(@PathVariable Long id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteEventAttach(@PathVariable Long id) {
