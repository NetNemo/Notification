 ...
 */
@Entity
@Table(name = "user_channel_configuration")
public class UserChannelConfiguration implements Serializable {
    ...
    @Column(name = "slack_token_1")
    private String slackToken1;

    @Column(name = "slack_token_2")
    private String slackToken2;

    @Column(name = "slack_token_3")
    private String slackToken3;

    @OneToMany(mappedBy = "userChannelConfiguration")
